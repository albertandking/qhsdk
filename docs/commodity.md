...
|:-----  |:-----|-----|
|symbol |查询品种编码   |MA|
|date |查询日期   |2019-12-25|
|type |类型   |1表示多头榜，2表示空头榜|
...
|:-----  |:-----|-----|
|broker |string   |席位  |
|net_position |int   |净持仓量，单位手  |
|net_position_chge |int   |净持仓变化量，单位手  |
...
```
   broker  net_position  net_position_chge
0    一德期货         27043              14315
1    鲁证期货         21139                -81
2    海通期货         14031               8570
3    光大期货         13966               8400
